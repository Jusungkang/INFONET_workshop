...
for zzz in range(Avg_times):
    ...
    for k in range(len(SNR_range)):
        ...
        new_model.load_state_dict(torch.load("./Models/RF_fingerprinting/[" + str(zzz) + "][" + str(model_version) + "][VAL]Classifier_" + str(SNR) + ".pth"))
        ...
        with torch.no_grad():
            ...
            for i, data in enumerate(test_loader):
                ...
                np.savetxt("./Models/RF_fingerprinting/[" + str(zzz) + "][" + str(model_version) + "][VAL]Classifier_" + str(SNR) + "_conf_mat.csv", Conf_mat, delimiter=",")
        ...
        np.savetxt('./Models/RF_fingerprinting/[' + str(zzz) + '][' + str(model_version) + '][VAL]Testing_result.csv', SNR_result)
